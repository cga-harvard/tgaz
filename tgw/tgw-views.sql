...
FROM part_of po, placename pn, spelling sp_vn, spelling sp_tr, script
...
-- FIXME trsys needs further constraint to avoid multiples
-- previous version listed scripts:
